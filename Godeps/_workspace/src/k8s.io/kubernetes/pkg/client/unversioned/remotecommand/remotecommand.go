...
import (
	...
	"github.com/gravitational/planet/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util/httpstream"
	"github.com/gravitational/planet/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util/httpstream/spdy"
)
