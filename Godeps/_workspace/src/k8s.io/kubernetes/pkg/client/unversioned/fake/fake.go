...
import (
	...
	"github.com/gravitational/planet/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/testapi"
	"github.com/gravitational/planet/Godeps/_workspace/src/k8s.io/kubernetes/pkg/client/unversioned"
