...
import (
	...
	"github.com/gravitational/planet/Godeps/_workspace/src/github.com/golang/glog"

	"github.com/gravitational/planet/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api"
	"github.com/gravitational/planet/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/latest"
	"github.com/gravitational/planet/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/meta"
	"github.com/gravitational/planet/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/registered"
	apiutil "github.com/gravitational/planet/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/util"
	_ "github.com/gravitational/planet/Godeps/_workspace/src/k8s.io/kubernetes/pkg/apis/extensions"
	"github.com/gravitational/planet/Godeps/_workspace/src/k8s.io/kubernetes/pkg/apis/extensions/v1beta1"
	"github.com/gravitational/planet/Godeps/_workspace/src/k8s.io/kubernetes/pkg/runtime"
	"github.com/gravitational/planet/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util/sets"
)
