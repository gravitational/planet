...
func run() error {
	var (
		...
		cagentCriticalNamespaces     = List(cagent.Flag("critical-namespaces", "List of Kubernetes namespaces to search for critical system pods").OverrideDefaultFromEnvar(EnvCriticalNamespaces))
