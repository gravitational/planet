...
func run() error {
	...
	var (
		...
		cagentNettestContainerImage = cagent.Flag("nettest-container-image", "Name of the container image to use for networking test").Default("apiserver.com:5000/gcr.io/google_containers/nettest:1.6").String()
