...
const (
	...
	DefaultFeatureGates = "AllAlpha=true,APIResponseCompression=false,BoundServiceAccountTokenVolume=false,KubeletPodResources=false,EndpointSlice=false,IPv6DualStack=false"
