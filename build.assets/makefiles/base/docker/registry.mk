...
$(BINARIES):
	...
	mkdir -p $(REPODIR)
	# Temporarily disabled because we need a commit currently only on the master branch, to be restored when 2.7.2 or later is released
	# TODO(knisbet) restore shallow clone when upstream has release with TLS1.2 restriction support
	# cd $(REPODIR) && git clone https://github.com/docker/distribution -b $(VER) --depth 1
	cd $(REPODIR) && git clone https://github.com/docker/distribution && cd distribution && git checkout 6d62eb1d4a3515399431b713fde3ce5a9b40e8d5
